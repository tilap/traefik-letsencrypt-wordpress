...
class WpCallButtonWidget extends \WP_Widget {
	...
	public function __construct() {
		...
		// Load widget.
		parent::__construct( $widget_slug, esc_html_x( 'WP Call Button', 'Widget', $plugin_slug ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$call_button_text = '<span style="color:' . esc_attr( $instance['cta_txt_color'] ) . '">' . ( $instance['show_phone_icon'] ? '<img style="width: 70px; height: 30px; vertical-align: middle;" src="' . WpCallButtonHelpers::get_phone_image( $instance['cta_txt_color'] ) . '" />' : '' ) . esc_html( $instance['cta_text'] ) . '</span>';
	...
	public function form( $instance ) {
		...
		<div class="wpcb-widget-item">
			...
			<textarea id="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>"
			       name="<?php echo esc_attr( $this->get_field_name( 'description' ) ); ?>" class="widefat"><?php echo esc_html( $instance['description'] ); ?></textarea>
		</div>
		...
		<div class="wpcb-widget-settings" style="display: none;">
			...
			<div class="wpcb-widget-item">
				...
				<input type="text"
							 ...
							 value="<?php echo esc_attr( $instance['cta_color'] ); ?>" class="widefat"/>
			</div>
			<div class="wpcb-widget-item">
				...
				<input type="text"
							 ...
							 value="<?php echo esc_attr( $instance['cta_txt_color'] ); ?>" class="widefat"/>
			</div>
			<div class="wpcb-widget-item">
