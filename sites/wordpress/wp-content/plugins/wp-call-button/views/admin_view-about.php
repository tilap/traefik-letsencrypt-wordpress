                  ...
                  <p>
                    ...
                    printf(
                      wp_kses(
                        ...
                        __( 'WP Call Button is brought to you by the team behind <a href="%1$s" target="_blank" rel="noopener noreferrer">WPBeginner</a> '.
                           'in collaboration with our friends at <a href="%2$s" target="_blank" rel="noopener noreferrer">Nextiva</a>, business phone service. '.
                           'Our team is also behind other popular plugins like <a href="%3$s" target="_blank" rel="noopener noreferrer">WPForms</a>, '.
                           '<a href="%4$s" target="_blank" rel="noopener noreferrer">MonsterInsights</a>, <a href="%5$s" target="_blank" rel="noopener noreferrer">OptinMonster</a>, '.
                           '<a href="%6$s" target="_blank" rel="noopener noreferrer">WP Mail SMTP</a>, <a href="%7$s" target="_blank" rel="noopener noreferrer">SeedProd</a>, '.
                           '<a href="%8$s" target="_blank" rel="noopener noreferrer">RafflePress</a>, <a href="%9$s" target="_blank" rel="noopener noreferrer">TrustPulse</a> and more.', 'wp-call-button' ),
                        array(
                          'a' => array(
                            'href'   => array(),
                            'rel'    => array(),
